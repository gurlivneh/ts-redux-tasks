...
import { loadUserEvents, selectUserEventsArray} from '../../redux/user-events';

const Calendar: React.FC = () => {
    const userEvents = useSelector(selectUserEventsArray)
    console.log('user events in calendar', userEvents)
