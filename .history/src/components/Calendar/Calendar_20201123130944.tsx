...
const Calendar: React.FC = () => {
	...
	const handleDelete = (event: any) => {
		dispatch(DeleteUserEvent(event))
	}
					...
					<Day key={i}>
						...
						<Events>
								...
								<Event key={i}>
									...
									<EventDeleteButton onClick={(event: React.MouseEvent<HTMLButtonElement, MouseEvent>) => handleDelete(event)}>&times;</EventDeleteButton>
								</Event>);
							})}
						</Events>
					</Day>);
