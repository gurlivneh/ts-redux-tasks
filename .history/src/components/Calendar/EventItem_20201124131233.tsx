	...
	return (
		<Event>
			<EventInfo>
				...
				{editable ? (
					<EventInput onBlur={handleTitleClick} onChange={handleTitleChange} ref={inputRef} value={event.title} />
				) : (
					<EventTitle onClick={handleTitleClick}>{event.title}</EventTitle>
				)}
			</EventInfo>
