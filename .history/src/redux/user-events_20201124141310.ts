...
const UPDATE_REQUEST = 'userEvnets/update_request';

interface UpdateRequestAction extends Action<typeof UPDATE_REQUEST> {}

const UPDATE_SUCCESS = 'userEvents/update_suscces';
...
export const UpdateUserEvent = (
	event: UserEvent
): ThunkAction<void, RootState, undefined, UpdateRequestAction | UpdateSuccessAction | UpdateFailureAction> => async (
	dispatch,
	getState
) => {
